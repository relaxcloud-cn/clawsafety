    ...
    <main className="min-h-screen">
      <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link href="/blog" className="text-sm text-gray-400 hover:text-white transition">&larr; Blog</Link>
        </div>
      </nav>
      ...
      <article className="pt-32 pb-20 px-6 max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300 leading-relaxed">
          ...
          <p>The injected MCP server uses tool description poisoning (see our <Link href="/blog/mcp-tool-poisoning" className="text-cyan-400 hover:underline">MCP Tool Poisoning article</Link>) to silently exfiltrate:</p>
