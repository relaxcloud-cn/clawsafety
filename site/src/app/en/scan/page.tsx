    ...
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/en" className="text-xl font-bold hover:text-gray-300 transition">
            ClawSafety
          </Link>
          <div className="flex items-center gap-6">
            ...
            <Link href="/scan" className="text-sm text-gray-400 hover:text-white transition">中文</Link>
          </div>
        </div>
      </nav>
